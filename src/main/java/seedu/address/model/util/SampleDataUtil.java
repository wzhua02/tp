    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"),
                    ...
                    new Email("alexyeoh@example.com"), new Goals("Get fitter"), new MedicalHistory("Lower back injury"),
                    new Location("Blk 30 Geylang Street 29, #06-40"),
                    getOneTimeScheduleSet("25/02 1000 1200", "01/03 1000 1200"), getTagSet("friends")),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), getRecurringScheduleSet("Mon 1400 1600"),
                    new Email("berniceyu@example.com"),
                    new Goals("Lose weight"), new MedicalHistory("Upper back injury"),
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                    ...
                    new Goals("Gain muscle mass"), new MedicalHistory("Right shoulder dislocated"),
            ...
            new Person(new Name("David Li"), new Phone("91031282"),
                    ...
                    new Goals("Get stronger"), new MedicalHistory("Left shoulder dislocated"),
            ...
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"),
                    ...
                    new Goals("Work on stamina"), new MedicalHistory("Fractured right hand"),
            ...
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"),
                    ...
                    new Goals("Calisthenics improvement"), new MedicalHistory("Fractured left hand"),
