    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                    ...
                    new MedicalHistory("Right shoulder dislocated"), new Location("Blk 11 Ang Mo Kio Street 74, #11-04"),
            ...
            new Person(new Name("David Li"), new Phone("91031282"),
                    ...
                    new MedicalHistory("Left shoulder dislocated"), new Location("Blk 436 Serangoon Gardens Street 26, #16-43"),
