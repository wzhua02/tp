...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + RECURRING_SCHEDULE_DESC_BOB
                + LOCATION_DESC_BOB + ONETIMESCHEDULE_DESC_BOB + TAG_DESC_FRIEND;
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + RECURRING_SCHEDULE_DESC_BOB
                + LOCATION_DESC_BOB + GOALS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + RECURRING_SCHEDULE_DESC_BOB
                + LOCATION_DESC_BOB + GOALS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + RECURRING_SCHEDULE_DESC_BOB
                        + INVALID_LOCATION_DESC + GOALS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Location.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + RECURRING_SCHEDULE_DESC_BOB
                + LOCATION_DESC_BOB + GOALS_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND, Tag.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + RECURRING_SCHEDULE_DESC_BOB
                + GOALS_DESC_BOB + INVALID_LOCATION_DESC, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + RECURRING_SCHEDULE_DESC_BOB
                        + PHONE_DESC_BOB + GOALS_DESC_BOB + LOCATION_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
