...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_MEDICAL_HISTORY_DESC,
                Email.MESSAGE_CONSTRAINTS); // invalid medical history
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + MEDICAL_HISTORY_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withMedicalHistory(VALID_MEDICAL_HISTORY_AMY)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // email
        userInput = targetIndex.getOneBased() + MEDICAL_HISTORY_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withMedicalHistory(VALID_MEDICAL_HISTORY_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
