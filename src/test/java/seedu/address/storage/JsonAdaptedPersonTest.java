...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_GOALS, VALID_MEDICAL_HISTORY,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_GOALS,
                        VALID_MEDICAL_HISTORY, VALID_LOCATION, VALID_ONETIMESCHEDULES, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_GOALS,
                        VALID_MEDICAL_HISTORY, VALID_LOCATION, VALID_ONETIMESCHEDULES, VALID_TAGS);
    ...
    public void toModelType_invalidMedicalHistory_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_GOALS, INVALID_MEDICAL_HISTORY,
                        VALID_LOCATION, VALID_ONETIMESCHEDULES, VALID_TAGS);
    ...
    public void toModelType_nullMedicalHistory_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_GOALS, null,
                VALID_LOCATION, VALID_ONETIMESCHEDULES, VALID_TAGS);
    ...
    public void toModelType_invalidGoals_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_GOALS,
                        VALID_MEDICAL_HISTORY, VALID_LOCATION, VALID_ONETIMESCHEDULES, VALID_TAGS);
    ...
    public void toModelType_invalidLocation_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_GOALS,
